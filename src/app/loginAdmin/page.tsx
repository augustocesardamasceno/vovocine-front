...
import { AccessToken, Credentials, EasyAdmin } from '@/resources/admin/admins.resources'
...
export default function Login(){
    ...
    async function onSubmit(values: LoginForm){
        if(!newUserState){
            const adminCredentials: Credentials = { email: values.email, password: values.password }
            
            try {
                const accessToken: AccessToken = await auth.authenticate(adminCredentials);
            ...
            const admin: EasyAdmin = { email: values.email, name: values.name, password: values.password }
