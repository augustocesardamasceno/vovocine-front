...
import { RenderIf, InputText, Button, FieldError, useNotification } from '@/components'
...
import { AcessToken, Credentials, EasyUser } from '@/resources/user/users.resources'
...
export default function LoginUser(){
    ...
    async function onSubmit(values: LoginForm){
        if(!newUserState){
                const userCredentials: Credentials = { email: values.email, password: values.password }
                try{
            ...
            const user: EasyUser = { email: values.email, name: values.name, password: values.password }
